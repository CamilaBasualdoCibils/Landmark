...
Pipeline::Pipeline(const PipelineProperties &_info, const PipelineLayout &_layout, const RenderPass &rp,
                   uint32_t subpass)
    : info(_info)
{
    ...
    vk::Viewport viewport{info.renderProperties.ViewportMin.x,
                          info.renderProperties.ViewportMin.y,
                          info.renderProperties.ViewportSize.x,
                          info.renderProperties.ViewportSize.y,
                          0,
                          1};
