...
void Editor::Init()
{
	toolGroups.PushObject<EditorObjectGroup>(INT64_MIN, "File");
	auto& viewgroup = toolGroups.PushObject<EditorObjectGroup>(2, "View");

	auto& options = viewgroup.PushObject<EditorObjectGroup>(INT64_MIN, "Options");
	options.PushObject<EditorLambda>(INT64_MIN, "Font Scale", []()
		{
...
void Editor::Draw()
{
	...
	if (ImGui::BeginMenuBar())
	{
		...
		toolGroups.DrawHandleWithoutMenu();
		ImGui::EndMenuBar();
	}
	ImGui::End();
