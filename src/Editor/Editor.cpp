...
void Editor::Editor::Draw()
{
    ...
    ImGui::PopStyleVar(3);
    {
        ...
        ImGui::GetWindowDrawList()->AddRect({pos.x + size.x / 2 - textsize.x / 2, pos.y + size.y / 2 - textsize.y / 2},
                                            {pos.x + size.x / 2 + textsize.x / 2, pos.y + size.y / 2 + textsize.y / 2},
                                            LogoColor, 6, 0, 1);
        // ImGui::GetWindowDrawList()->AddText({pos.x + size.x / 2 - textsize.x / 2, pos.y + size.y / 2 - textsize.y /
        // 2}, LogoColor, LandmarkLogo.c_str());
    }
