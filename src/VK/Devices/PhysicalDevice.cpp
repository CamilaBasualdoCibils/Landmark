...
PhysicalDevice::PhysicalDevice(const vk::PhysicalDevice& pd,vk::SurfaceKHR* surface):physicalDevice(pd),
                                                             ...
                                                             queueFamilies(FetchQueueFamilies(surface)),
...
std::vector<QueueFamily> PhysicalDevice::FetchQueueFamilies(vk::SurfaceKHR* surface)
{
	...
	for (int i = 0; i < queueFamilyCount; i++)
		queueFamilies.emplace_back(physicalDevice, i,surface);
